...
CREATE TABLESPACE TablaSpaceProyecto
  DATAFILE 'C:\Oracle\proyecto\TablaSpaceProyecto.dbf' 
  SIZE 100M
...
SELECT Categoria, COUNT(ID_Hotel) AS Total_Hoteles
FROM TBL_Hoteles
GROUP BY Categoria;
...
FROM 
    TBL_Vuelos V
JOIN 
    TBL_Reservas R ON V.ID_Vuelo = R.ID_Vuelo
JOIN 
...
--Otras operaciones Crud para la tabla clientes
...
INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (520.00, TO_DATE('2024-02-04', 'YYYY-MM-DD'), 'Transferencia Bancaria', 31);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (250.00, TO_DATE('2024-02-05', 'YYYY-MM-DD'), 'PayPal', 32);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (180.00, TO_DATE('2024-02-06', 'YYYY-MM-DD'), 'Tarjeta de Débito', 33);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (400.00, TO_DATE('2024-02-07', 'YYYY-MM-DD'), 'Efectivo', 34);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (325.00, TO_DATE('2024-02-08', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 35);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (415.50, TO_DATE('2024-02-09', 'YYYY-MM-DD'), 'Transferencia Bancaria', 36);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (290.00, TO_DATE('2024-02-10', 'YYYY-MM-DD'), 'PayPal', 37);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (150.00, TO_DATE('2024-02-11', 'YYYY-MM-DD'), 'Tarjeta de Débito', 38);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (275.00, TO_DATE('2024-02-12', 'YYYY-MM-DD'), 'Efectivo', 39);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (310.00, TO_DATE('2024-02-13', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 40);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (480.00, TO_DATE('2024-02-14', 'YYYY-MM-DD'), 'Transferencia Bancaria', 41);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (210.50, TO_DATE('2024-02-15', 'YYYY-MM-DD'), 'PayPal', 42);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (315.00, TO_DATE('2024-02-16', 'YYYY-MM-DD'), 'Tarjeta de Débito', 43);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (145.00, TO_DATE('2024-02-17', 'YYYY-MM-DD'), 'Efectivo', 44);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (320.00, TO_DATE('2024-02-18', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 45);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (540.00, TO_DATE('2024-02-19', 'YYYY-MM-DD'), 'Transferencia Bancaria', 46);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (190.00, TO_DATE('2024-02-20', 'YYYY-MM-DD'), 'PayPal', 47);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (365.00, TO_DATE('2024-02-21', 'YYYY-MM-DD'), 'Tarjeta de Débito', 48);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (425.00, TO_DATE('2024-02-22', 'YYYY-MM-DD'), 'Efectivo', 49);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (230.00, TO_DATE('2024-02-23', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 50);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (375.50, TO_DATE('2024-02-24', 'YYYY-MM-DD'), 'Transferencia Bancaria', 51);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (290.00, TO_DATE('2024-02-25', 'YYYY-MM-DD'), 'PayPal', 52);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (180.00, TO_DATE('2024-02-26', 'YYYY-MM-DD'), 'Tarjeta de Débito', 53);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (400.00, TO_DATE('2024-02-27', 'YYYY-MM-DD'), 'Efectivo', 54);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (325.00, TO_DATE('2024-02-28', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 55);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (415.50, TO_DATE('2024-03-01', 'YYYY-MM-DD'), 'Transferencia Bancaria', 56);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (290.00, TO_DATE('2024-03-02', 'YYYY-MM-DD'), 'PayPal', 57);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (150.00, TO_DATE('2024-03-03', 'YYYY-MM-DD'), 'Tarjeta de Débito', 58);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (275.00, TO_DATE('2024-03-04', 'YYYY-MM-DD'), 'Efectivo', 59);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (310.00, TO_DATE('2024-03-05', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 60);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (520.00, TO_DATE('2024-03-06', 'YYYY-MM-DD'), 'Transferencia Bancaria', 61);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (250.00, TO_DATE('2024-03-07', 'YYYY-MM-DD'), 'PayPal', 62);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (180.00, TO_DATE('2024-03-08', 'YYYY-MM-DD'), 'Tarjeta de Débito', 63);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (400.00, TO_DATE('2024-03-09', 'YYYY-MM-DD'), 'Efectivo', 64);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (325.00, TO_DATE('2024-03-10', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 65);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (415.50, TO_DATE('2024-03-11', 'YYYY-MM-DD'), 'Transferencia Bancaria', 66);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (290.00, TO_DATE('2024-03-12', 'YYYY-MM-DD'), 'PayPal', 67);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (150.00, TO_DATE('2024-03-13', 'YYYY-MM-DD'), 'Tarjeta de Débito', 68);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (275.00, TO_DATE('2024-03-14', 'YYYY-MM-DD'), 'Efectivo', 69);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (310.00, TO_DATE('2024-03-15', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 70);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (450.00, TO_DATE('2024-03-16', 'YYYY-MM-DD'), 'Transferencia Bancaria', 71);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (310.00, TO_DATE('2024-03-17', 'YYYY-MM-DD'), 'PayPal', 72);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (230.00, TO_DATE('2024-03-18', 'YYYY-MM-DD'), 'Tarjeta de Débito', 73);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (390.00, TO_DATE('2024-03-19', 'YYYY-MM-DD'), 'Efectivo', 74);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (285.00, TO_DATE('2024-03-20', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 75);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (395.50, TO_DATE('2024-03-21', 'YYYY-MM-DD'), 'Transferencia Bancaria', 76);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (250.00, TO_DATE('2024-03-22', 'YYYY-MM-DD'), 'PayPal', 77);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (170.00, TO_DATE('2024-03-23', 'YYYY-MM-DD'), 'Tarjeta de Débito', 78);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (270.00, TO_DATE('2024-03-24', 'YYYY-MM-DD'), 'Efectivo', 79);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (300.00, TO_DATE('2024-03-25', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 80);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (360.00, TO_DATE('2024-03-26', 'YYYY-MM-DD'), 'Transferencia Bancaria', 81);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (280.00, TO_DATE('2024-03-27', 'YYYY-MM-DD'), 'PayPal', 82);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (250.00, TO_DATE('2024-03-28', 'YYYY-MM-DD'), 'Tarjeta de Débito', 83);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (410.00, TO_DATE('2024-03-29', 'YYYY-MM-DD'), 'Efectivo', 84);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (320.00, TO_DATE('2024-03-30', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 85);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (380.00, TO_DATE('2024-03-31', 'YYYY-MM-DD'), 'Transferencia Bancaria', 86);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (260.00, TO_DATE('2024-04-01', 'YYYY-MM-DD'), 'PayPal', 87);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (190.00, TO_DATE('2024-04-02', 'YYYY-MM-DD'), 'Tarjeta de Débito', 88);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (330.00, TO_DATE('2024-04-03', 'YYYY-MM-DD'), 'Efectivo', 89);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (300.00, TO_DATE('2024-04-04', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 90);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (410.00, TO_DATE('2024-04-05', 'YYYY-MM-DD'), 'Transferencia Bancaria', 91);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (275.50, TO_DATE('2024-04-06', 'YYYY-MM-DD'), 'PayPal', 92);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (200.00, TO_DATE('2024-04-07', 'YYYY-MM-DD'), 'Tarjeta de Débito', 93);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (420.00, TO_DATE('2024-04-08', 'YYYY-MM-DD'), 'Efectivo', 94);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (295.00, TO_DATE('2024-04-09', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 95);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (465.00, TO_DATE('2024-04-10', 'YYYY-MM-DD'), 'Transferencia Bancaria', 96);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (315.00, TO_DATE('2024-04-11', 'YYYY-MM-DD'), 'PayPal', 97);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (240.00, TO_DATE('2024-04-12', 'YYYY-MM-DD'), 'Tarjeta de Débito', 98);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (355.00, TO_DATE('2024-04-13', 'YYYY-MM-DD'), 'Efectivo', 99);

INSERT INTO TBL_Pagos (Monto, Fecha_Pago, Metodo_Pago, ID_Reserva) 
VALUES (280.00, TO_DATE('2024-04-14', 'YYYY-MM-DD'), 'Tarjeta de Crédito', 100);
...
SELECT*FROM TBL_Reservas_Tours WHERE ID_Tour=6;
